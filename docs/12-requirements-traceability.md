...
| Task 7 — Worktree/process | HP-US-021, HP-US-031 | local disposable-fixture dirty/unique-work preservation, leases, Windows/Ubuntu process-tree containment, reconnect/cancel receipts PASS; remote CI PENDING |
