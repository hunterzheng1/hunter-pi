...
- Task 8 docs follow-up CI: **PASS after preserving one Ubuntu containment rerun** — docs PR run [`30986236506`](https://github.com/hunterzheng1/hunter-pi/actions/runs/30986236506) first recorded the same structured Ubuntu Task 7 probe failure, then its failed job was rerun without source changes and all jobs passed; docs merge main run [`30987578579`](https://github.com/hunterzheng1/hunter-pi/actions/runs/30987578579) passed all six jobs.
- Task 8 CI-history follow-up: PR run [`30988816659`](https://github.com/hunterzheng1/hunter-pi/actions/runs/30988816659) retained two Ubuntu quality timeouts in the nested process-tree test (304/308 tests passed each time); the focused test passed on local Windows and WSL Ubuntu, and the bounded test-only timeout adjustment is pending its replacement CI run.
