...
- Product status: **TASK_9_11_LOCAL_PASS / TASK_12_REAL_PILOT_NOT_PROVEN / REPLACEMENT_PR_CI_PASS / MAIN_CI_PENDING**
...
- Next gate: obtain exact Windows/Ubuntu main CI for the hardened source, then execute the frozen Task 12 Windows pilot against explicitly selected repositories; no daily-use GO is claimed before those receipts exist
