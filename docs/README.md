...
- Daily-use acceptance: **NOT_PROVEN** — the exact merged-head main CI receipt now exists, but no exact Task 12 real-use Archive exists; PR/main CI alone is insufficient
