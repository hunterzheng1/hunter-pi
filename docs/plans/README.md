...
Task 7 is the only active task. Its implementation and exact local Windows/Ubuntu fixture Evidence pass, while PR/main CI remains `PENDING`. Its detailed execution and hard-stop rules are frozen in [2026-08-04 — Task 7 worktree, leases, and process host](2026-08-04-task7-worktree-leases-process-host.md). Real repositories and Provider requests remain prohibited during Task 7.
