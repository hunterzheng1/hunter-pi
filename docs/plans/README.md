...
The active Hunter Pi `0.1.0-dev.1` release work pins Pi `0.84.1` and adds the Windows ZIP plus single-source PowerShell installer. Its current clean-first local gate passes 73 files / 733 tests, but exact main CI, Release assets, published-URL installation, and new daily-use acceptance are separate gates. The Pi 0.83 Archive cannot satisfy them.
