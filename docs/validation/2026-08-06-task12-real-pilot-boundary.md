...
The current `main` head is `29d2ef2` (`docs: close Task 12 CI evidence`). Its exact main CI run [`31104828696`](https://github.com/hunterzheng1/hunter-pi/actions/runs/31104828696) passed the recorded Windows, Ubuntu, containment, Task 7 Evidence, and Pi Evidence jobs. This proves the checked-in implementation and its provider-neutral verification gates at their documented scope; it does not constitute a Task 12 real-use acceptance.
