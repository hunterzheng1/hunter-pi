...
- Windows temporary-Git tests prove clean-root detection, dirty-root blocking, detached-HEAD blocking, symlink/junction and non-root blocking without path leakage, and that a repository-configured fsmonitor command is not executed.
